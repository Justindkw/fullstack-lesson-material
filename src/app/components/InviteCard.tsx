    ...
    return (
        <article className="flex my-2 justify-between">
            ...
            <div className="flex gap-2">
                {onAccept ?
                    <button className="group w-10 bg-secondary rounded-full" onClick={onAccept}>
                        <img src="/icons/add.png" alt="add" className="w-6 m-auto group-hover:brightness-125"/>
                    </button> :
                    <></>
                }
                <button className="w-10 bg-secondary rounded-full group" onClick={onCancel}>
                    <img src="/icons/cancel.png" alt="remove" className="w-5 m-auto group-hover:brightness-125"/>
                </button>
            </div>
        </article>
    )
